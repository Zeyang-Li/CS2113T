...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_CS2101 + STARTDATE_DESC_CS2101
                ...
                + TAG_DESC_CS2101, new AddCommand(expectedTask));
        ...
        assertParseSuccess(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101
                + STARTTIME_DESC_CS2101 + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101
                + TAG_DESC_CS2101 + TAG_DESC_CS2113, new AddCommand(expectedTaskMultipleTags));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_CS2113 + STARTDATE_DESC_CS2101
                + STARTTIME_DESC_CS2101 + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + VALID_ENDDATE_CS2101 + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101, expectedMessage);

        // missing endTime prefix
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + VALID_ENDTIME_CS2101 + DESCRIPTION_DESC_CS2101, expectedMessage);

        // missing description prefix
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + VALID_DESCRIPTION_CS2101, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_CS2101 + VALID_STARTDATE_CS2101 + VALID_STARTTIME_CS2101
                + VALID_ENDDATE_CS2101 + VALID_ENDTIME_CS2101 + VALID_DESCRIPTION_CS2113, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101 + TAG_DESC_CS2101,
        ...
        // invalid endDate
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + INVALID_ENDDATE_DESC + ENDTIME_DESC_CS2101 + DESCRIPTION_DESC_CS2101 + TAG_DESC_CS2101,
                EndDate.MESSAGE_CONSTRAINTS);

        // invalid endTime
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + INVALID_ENDTIME_DESC + DESCRIPTION_DESC_CS2101 + TAG_DESC_CS2101,
                EndTime.MESSAGE_CONSTRAINTS);

        // invalid description
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + INVALID_DESCRIPTION_DESC + TAG_DESC_CS2101,
                Description.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_CS2101 + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + INVALID_DESCRIPTION_DESC + INVALID_TAG_DESC,
                Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + STARTDATE_DESC_CS2101 + STARTTIME_DESC_CS2101
                + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + INVALID_DESCRIPTION_DESC,
                Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_CS2101 + STARTDATE_DESC_CS2101
                + STARTTIME_DESC_CS2101 + ENDDATE_DESC_CS2101 + ENDTIME_DESC_CS2101 + INVALID_DESCRIPTION_DESC,
