...
public class ParserUtilTest {
    ...
    public void parseStartDate_null_throwsNullPointerException() {
        Assert.assertThrows(NullPointerException.class, () -> ParserUtil.parseStartDate((String) null));
    }

    @Test
    public void parseStartDate_invalidValue_throwsParseException() {
        Assert.assertThrows(ParseException.class, () -> ParserUtil.parseStartDate(INVALID_STARTDATE));
    }

    @Test
    public void parseStartDate_validValueWithoutWhitespace_returnsStartDate() throws Exception {
        StartDate expectedStartDate = new StartDate(VALID_STARTDATE);
        assertEquals(expectedStartDate, ParserUtil.parseStartDate(VALID_STARTDATE));
    }

    @Test
    public void parseStartDate_validValueWithWhitespace_returnsTrimmedStartDate() throws Exception {
        String startDateWithWhitespace = WHITESPACE + VALID_STARTDATE + WHITESPACE;
        StartDate expectedStartDate = new StartDate(VALID_STARTDATE);
