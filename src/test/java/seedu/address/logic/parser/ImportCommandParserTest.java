...
public class ImportCommandParserTest {
    ...
    public void parse_validArgs_success() {
        ...
        filePath = Paths.get("data", "testImportFile.json");
        expectedCommand = new ImportCommand(filePath);

        // parse user input without whitespaces
        assertParseSuccess(parser, " testImportFile.json", expectedCommand);
    ...
    public void parse_invalidFilename_throwsParseException() {
        // wrong filetype
        assertParseFailure(parser, "testImportFile.xml", MESSAGE_INVALID_FORMAT);
