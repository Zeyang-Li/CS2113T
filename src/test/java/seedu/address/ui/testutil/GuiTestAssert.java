...
public class GuiTestAssert {
    ...
    public static void assertCardDisplaysTask(Task expectedTask, TaskCardHandle actualCard) {
        ...
        assertEquals(expectedTask.getStartDate(), actualCard.getStartDate());
        assertEquals(expectedTask.getStartTime(), actualCard.getStartTime());
        assertEquals(expectedTask.getEndDate(), actualCard.getEndDate());
        assertEquals(expectedTask.getEndTime(), actualCard.getEndTime());
