...
.  !Important! Before every teammate fully understand the logic, please follow the next line.
.  !Important! We keep the original files on commands, and create our own command files so that we will not mess up the command files.
...
* !Important! Before every teammate fully understand the logic, please follow the next line:
* !Important! We keep the original files on model, and create our own model files so that we will not mess up the original model.
...
* Solution
** !Important! Before every teammate fully understand the logic, please follow the next line:
** !Important! We keep the original files on parser, and create our own parser files so that we will not mess up the logic.
