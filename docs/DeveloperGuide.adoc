...
.See usage function
..Role:New user
..Benefit: User can refer to instructions when forgotten

.Add task to a specific date
..Role:User
..Benefit: User can view what to do for the next few days

=== Priority 2 function

.Highlight today’s date 
..Role:User
..Benefit: User can know today’s date

.Add priority of the task 
..Role:User
..Benefit: User can set the importance of an task

.View priority of all events 
..Role:User
..Benefit: User can see all the events based on the priority

.list tasks of certain priority of this week
..Role:User
..Benefit: User can know what must be done in this week
