...
==== Current Implementation
There are mainly two parts in this features.
One is calendar, the other is timeline.
...
*** Inside the VBox, there are keyframes for every 2 hours. Then the timeline for each category.
