...
* NUS students who need to manage time due to multiple tasks, assignments and datelines
...
|`* * *` | user | clear tasks | remove all the completed tasks of a day or a month
