...
+
image::Ui.png[width="790"]*(this picture needs to be changed)*
+
...
* **`add`**`s/[startDateTime] e/endDateTime] t/[topic] d/[description]` : adds a contact named `John Doe` to the Address Book.
