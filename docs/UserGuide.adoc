...
Planner. Different dates means it is a long period task, thus will not be considered as daily task.
...
of the app (UI in development, can be verified in taskbook.json)
...
The day related to that edited task will be updated and shown in the day list. (UI in development, can be verified in taskbook.json)
