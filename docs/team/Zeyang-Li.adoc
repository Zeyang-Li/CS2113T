...
|https://github.com/CS2113-AY1819S2-T09-2/main[Github repo] |The underlined blue text indicates an URL link.
|=======================================================================

== Summary of contributions

|===
|The following section shows a summary of code, document and other minor helpful contribution to our project. And some URL for the pull requests and
|===

* *Major enhancement*: +
1. Added the ability to clear tasks which start from one specific date or month, as well as clear all tasks that are finished before today. +
    ** What it does: +
    It allows the user to clear some tasks that are no longer needed on the daily basis or the monthly basis or even clear all finished tasks in the storage. +
    ** Justification: +
    This feature improves the product significantly because a user can make clear a specific branch of tasks in the app.
    ** Highlights: +
...
2. Added the ability to give users suggestion when they type the command words wrongly. +
    ** What it does: +
    It is more user friendly because the system will be smart to guess what is the most similar command with the wrongly typed command word. +
    ** Justification: +
    [why we need to have this?]
    ** Highlights: +
    (what's so great about this feature, what should u know about this feature)
    ** Credits: +
    Codes and ideas related are inspired by https://github.com/CS2113-AY1819S1-W12-1/main[CS2113-AY1819S1-W12-1]

3. Added the ability to import a json file into Tasketch and also export filtered tasks ro all tasks in Tasketch into a json file.
** What it does: +
    It will also allow the users to import or export the tasks in Json file.
    ** Justification: +
    ** Highlights: +
    ** Credits: +
    Codes and ideas related are inspired by https://github.com/CS2113-AY1819S1-W12-1/main[CS2113-AY1819S1-W12-1]
...
|===
|_Given below are some sample sections I contributed to the User Guide. If you would like to see the original part in our UserGuide, you can click the underlined blue titles. +
...
==== https://github.com/CS2113-AY1819S2-T09-2/main/blob/master/docs/UserGuide.adoc#clearing-all-tasks-clearc[Clearing all tasks : `clear`/`c`]
...
// tag::suggestiom[]
=== https://github.com/CS2113-AY1819S2-T09-2/main/blob/master/docs/DeveloperGuide.adoc#suggestion-feature[Suggestion feature]
