...
*** Some of the codes in the export and import part are also used by my teammate Chunwei.
...
=== https://github.com/CS2113-AY1819S2-T09-2/main/blob/master/docs/DeveloperGuide.adoc#wrong-command-suggestion-feature[Wrong Command Suggestion feature]
...
image::WrongCommandSuggestionSequenceDiagram.png[width="650"]
